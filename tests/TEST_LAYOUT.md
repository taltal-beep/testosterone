...
- `tests/test_paths_behave_native.py` → `tests/unit/testo_core/test_paths_behave_native.py`
- `tests/test_command_builders_extended.py` → `tests/unit/testo_core/test_command_builders_extended.py`
- `tests/test_integrations_unit.py` → `tests/unit/testo_core/test_integrations_unit.py`
- `tests/test_integrations_more.py` → `tests/unit/testo_core/test_integrations_more.py`
- `tests/test_report_generator.py` → `tests/unit/testo_core/test_report_generator.py`
- `tests/test_report_generator_helpers.py` → `tests/unit/testo_core/test_report_generator_helpers.py`
- `tests/test_report_generator_http.py` → `tests/unit/testo_core/test_report_generator_http.py`
- `tests/test_report_generator_locust.py` → `tests/unit/testo_core/test_report_generator_locust.py`
- `tests/test_report_generator_static_sync.py` → `tests/unit/testo_core/test_report_generator_static_sync.py`
- `tests/test_report_service_more.py` → `tests/unit/testo_core/test_report_service_more.py`
- `tests/test_run_history_unit.py` → `tests/unit/testo_core/test_run_history_unit.py`
- `tests/test_run_history_snapshot.py` → `tests/unit/testo_core/test_run_history_snapshot.py`
- `tests/test_result_management.py` → `tests/unit/testo_core/test_result_management.py`
- `tests/test_event_drain.py` → `tests/unit/testo_core/test_event_drain.py`
- `tests/test_services.py` → `tests/unit/testo_core/test_services.py`
- `tests/test_runners_unit.py` → `tests/unit/testo_core/test_runners_unit.py`
- `tests/test_runners_audit_mock.py` → `tests/unit/testo_core/test_runners_audit_mock.py`
- `tests/test_runners.py` → `tests/unit/testo_core/test_runners.py`
- `tests/test_metrics.py` → `tests/unit/testo_core/test_metrics.py`
- `tests/test_metrics_advanced.py` → `tests/unit/testo_core/test_metrics_advanced.py`
- `tests/test_metrics_extractor_unit.py` → `tests/unit/testo_core/test_metrics_extractor_unit.py`
- `tests/test_metrics_extractor_more.py` → `tests/unit/testo_core/test_metrics_extractor_more.py`
